...
class FieldEvent(Base):
    ...
    visual_observations: Mapped[list[str] | None] = mapped_column(JSON)
    interpretation: Mapped[list[str] | None] = mapped_column(JSON)
    recommendations: Mapped[list[str] | None] = mapped_column(JSON)
    actions_taken: Mapped[list[str] | None] = mapped_column(JSON)
